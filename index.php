...
$conn = mysqli_connect('localhost','root','','contact_db','3307') or die('connection failed');
...
<!-- header section starts  -->k

<header class="header">

    <a href="#" class="logo"> <i class="fas fa-heartbeat"></i> <strong>Nikita</strong>medical </a>
